     ...
     Courses Levels</p>
      ...
      <div className={`grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4`}>
        {courses.map((course, index) => (
          <div key={index} className={`bg-gray-300 bg-opacity-10 p-6  border ${dark?'border-amber-900':'border-amber-600'}  py-20 px-10 rounded-lg `}>
            ...
            <button className="bg-amber-700 hover:bg-amber-800  text-white font-bold py-2 px-4 rounded mt-10">
              View Courses
            </button>
          </div>
        ))}
